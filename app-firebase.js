                        ...
                        <textarea id="firebaseConfigInput" placeholder='Paste your config here, like:
{
  ...
  "appId": "..."
    ...
    async moveTruckUp(truckId, station) {
        ...
        const tempOrder = currentTruck.stationOrder || currentIndex;
        currentTruck.stationOrder = aboveTruck.stationOrder || (currentIndex - 1);
        aboveTruck.stationOrder = tempOrder;
    ...
    async moveTruckDown(truckId, station) {
        ...
        const tempOrder = currentTruck.stationOrder || currentIndex;
        currentTruck.stationOrder = belowTruck.stationOrder || (currentIndex + 1);
        belowTruck.stationOrder = tempOrder;
