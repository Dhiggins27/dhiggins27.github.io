                        ...
                        <textarea id="firebaseConfigInput" placeholder='Paste your config here, like:
{
  ...
  "appId": "..."
    ...
    useDefaultFirebase() {
        // Default shared Firebase config for fire departments
        // This is a demo config - in production, you'd create a real one
        const defaultConfig = {
            apiKey: "AIzaSyDemoKey-ReplaceWithReal",
        ...
        alert('✅ Shared database configured! The app will now reload.');
